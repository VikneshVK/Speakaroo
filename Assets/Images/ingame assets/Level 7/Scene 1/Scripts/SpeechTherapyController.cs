...
public class SpeechTherapyController : MonoBehaviour
{
    ...
    private IEnumerator WaitForRetryButtonClick()
    {
        ...
        if (retryCount == 0)
        {
            ...
            {
                jojoController.panel1Complete = true;
    ...
    private void UpdatePrefabToSpawn()
    {
        switch (retryButtonActivatedBy)
        {
            case ButtonType.Button1:
                jojoController.PrefabToSpawn = 1;
                break;
            case ButtonType.Button2:
                jojoController.PrefabToSpawn = 2;
                break;
            case ButtonType.Button3:
                jojoController.PrefabToSpawn = 3;
                break;
            default:
