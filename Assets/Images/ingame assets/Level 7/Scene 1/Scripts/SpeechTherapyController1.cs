...
public class SpeechTherapyController1 : MonoBehaviour
{
    ...
    private IEnumerator WaitForRetryButtonClick()
    {
        ...
        if (retryCount == 0)
        {
            ...
            {
                jojoController.panel2Complete = true;
    ...
    private void UpdatePrefabToSpawn()
    {
        switch (retryButtonActivatedBy)
        {
            case ButtonType.Button1:
                jojoController.PrefabToSpawn = 4;
                break;
            case ButtonType.Button2:
                jojoController.PrefabToSpawn = 5;
                break;
            case ButtonType.Button3:
                jojoController.PrefabToSpawn = 6;
                break;
            default:
